...
export declare const FETCH_LANGTAGS = "FETCH_LANGTAGS";
export declare const FETCH_SCRIPTFONTS = "FETCH_SCRIPTFONTS";
...
export declare type LangTagMsgs = FetchLangTags | FetchScriptFonts;
export {};
